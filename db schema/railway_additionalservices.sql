...
CREATE TABLE `additionalservices` (
  ...
  CONSTRAINT `additionalservices_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`booking_id`)
...
INSERT INTO `additionalservices` VALUES (1,11,'Travel Concierge',20.00),(2,11,'Luggage Handling',15.00);
